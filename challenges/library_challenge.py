...
check_out(book = "THE COLOR OF LAW")
print(books)    
...
def search_by_name(book):
    if book in books:
        ...
        print("Not Available")
search_by_name('THE NEW JIM CROW')        
...
# books_with_details is a list of dictionaries 
# dictionaries contain curly brackets with key:value pairs, lists reside within hard brackets
...
def search_by_author(author):
    ...
    for book in books_with_details:
         if book['author'] == author:
            food_for_thought.append(book['title'])
